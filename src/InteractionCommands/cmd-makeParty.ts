// @ts-check
import { ChatInputCommandInteraction, SlashCommandBuilder, EmbedBuilder, User, Collection, ButtonBuilder, ActionRowBuilder, Colors, ButtonStyle, Snowflake, ComponentType } from "discord.js";
