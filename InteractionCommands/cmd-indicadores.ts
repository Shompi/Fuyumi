...
export = {
	...
	async execute(interaction: ChatInputCommandInteraction) {
		...
		const info: Mindicador.Indicadores = await request("https://mindicador.cl/api").then(response => response.body.json()).catch(err => console.error(err));
