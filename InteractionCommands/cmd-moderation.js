...
/* Comandos */
const mod_timeout_1 = require("./SubCommands/mod-timeout");
const mod_poll_1 = require("./SubCommands/mod-poll");
const mod_announce_1 = require("./SubCommands/mod-announce");
const mod_voiceRegion_1 = require("./SubCommands/mod-voiceRegion");
module.exports = {
    hasSubcommands: true,
    ...
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .addChannelOption(channel => channel.setName('canal').setDescription('El canal en donde quieres enviar la encuesta. (def: El canal donde usas el comando)').addChannelTypes(discord_js_1.ChannelType.GuildText))
        ...
        .setRequired(false)
        .addChoices({ name: "Brazil", value: "brazil" }, { name: "Japón", value: "japan" }, { name: "Estados Unidos Central", value: "us-central" }, { name: "Estados Unidos Este", value: "us-east" }, { name: "Estados Unidos Oeste", value: "us-west" }, { name: "Automático", value: "auto" }))),
    isGlobal: true,
    async execute(interaction) {
        ...
        if (interaction.memberPermissions.any(['Administrator', 'KickMembers', 'BanMembers', 'ModerateMembers'])) {
            ...
            switch (commandName) {
                case 'timeout':
                    return await (0, mod_timeout_1.TimeoutMember)(interaction);
                case 'anuncio':
                    return await (0, mod_announce_1.Announce)(interaction);
                case 'encuesta':
                    return await (0, mod_poll_1.Poll)(interaction);
                case 'region-de-voz':
                    return await (0, mod_voiceRegion_1.ChangeVoiceRegion)(interaction);
            }
        }
        else {
